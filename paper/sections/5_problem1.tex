...
表~\ref{tab:q1-confidence-sensitivity}给出置信水平扰动结果。接收信度由 $0.80$ 提高到 $0.99$ 时，首次能够接收的样本量由 $16$ 增至 $44$；信度越高，需要积累越多无次品证据。拒收方向的方向性样本量变化较小，是因为该指标只要求存在一个极端拒收结果，并不衡量一般不合格批次的检验功效，不能把 $n_R=1$ 或 $2$ 单独解释为充分的统一方案。
